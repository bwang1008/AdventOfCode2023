...
SPACE_MULTIPLIER: int = 1_000_000
...
def find_dist_between_two_galaxies(
    ...
    return (
        ...
        + (SPACE_MULTIPLIER - 1) * num_empty_rows_between_galaxies
        + abs(galaxy_b[1] - galaxy_a[1])
        + (SPACE_MULTIPLIER - 1) * num_empty_cols_between_galaxies
    )
...
def main() -> None:
    ...
    logger.info(f"{answer=}")  # 746207878188
